import { registerPhase1, registerPhase2, saveAccount } from '../lib/services/BankOfAIService.js';
import { stickyProxyPool } from '../lib/services/StickyProxyPool.js';
import { StickyProxyPool } from '../lib/services/StickyProxyPool.js';
...
async function fireLogin(proxy) {
  try {
